...
* **專案 GitHub 倉庫**（含 Arduino 雙緩衝韌體原始碼、EON 編譯函式庫、高解析架構圖與完整文檔）：  
  👉 **[https://github.com/blackbigg/tinyml-speaker-recognition](https://github.com/blackbigg/tinyml-speaker-recognition)**
* **實機聲學驗證展示影片**（包含本人控制與他人阻斷測試影片）：  
  👉 收錄於倉庫 `demo_videos/` 資料夾（`me_test1~2.mp4`, `others_go/stop.mp4`）。  
